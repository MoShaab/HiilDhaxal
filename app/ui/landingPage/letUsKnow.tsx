        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-white">
          ...
          <Fade direction={'up'} delay={1000} cascade damping={1e-1} triggerOnce={true}>
                            <div className='md:flex align-middle justify-center lg:justify-start'>
                                ...
                                <button className='flex border w-full md:w-auto mt-5 md:mt-0 border-pink justify-center bg-grey rounded-full text-xl font-medium items-center py-5 px-10 text-pink hover:text-white hover:bg-pink'><Link href='/#Contact'>Halkaan ku soo gudbi </Link></button>
                            </div>
          </Fade>
